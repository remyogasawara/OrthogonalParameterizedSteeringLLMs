# Only including no steer + inlier performance + eta = 0 performance here
# as this is redundant with other experiments
# so we have to merge these results post hoc to display them
