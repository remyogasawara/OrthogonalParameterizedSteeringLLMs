#!/bin/bash
#SBATCH --job-name=layer_sweep_pipeline
...
for LAYER in "${LAYERS[@]}"; do
    ...
    ACTIVATIONS_NAME="${DATE}_${BEHAVIORS_TAG}_layer${LAYER}"
    ALPHA_TRAIN_NAME="${DATE}_alpha-iterative_training_experiment_layer${LAYER}"
    PARAM_TRAIN_NAME="${DATE}_parameterized_training_experiment_layer${LAYER}"
